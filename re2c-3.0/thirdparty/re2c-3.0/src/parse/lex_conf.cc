...
#line 54 "parse/lex_conf.re"


void Scanner::lex_conf(Opt &opts) {
    tok = cur;

#line 46 "parse/lex_conf.cc"
{
	unsigned char yych;
...
yy42:
#line 59 "parse/lex_conf.re"
	{ lex_conf_input(opts); return; }
#line 358 "parse/lex_conf.cc"
yy43:
	yych = (unsigned char)*++cur;
	if (yych == '-') goto yy68;
	goto yy3;
...
#line 72 "parse/lex_conf.re"
	{ opts.set_eof(lex_conf_eof()); return; }
#line 402 "parse/lex_conf.cc"
yy53:
	yych = (unsigned char)*++cur;
	if (yych == 'g') goto yy77;
	goto yy3;
...
yy87:
#line 79 "parse/lex_conf.re"
	{ RET_CONF_BOOL(tags); }
#line 563 "parse/lex_conf.cc"
yy88:
	yych = (unsigned char)*++cur;
...
#line 154 "parse/lex_conf.re"
	{ RET_CONF_BOOL(unsafe); }
#line 853 "parse/lex_conf.cc"
yy149:
	yych = (unsigned char)*++cur;
...
#line 160 "parse/lex_conf.re"
	{ RET_CONF_ENC(Enc::UTF8); }
#line 942 "parse/lex_conf.cc"
yy170:
	yych = (unsigned char)*++cur;
	if (yybm[0+yych] & 32) {
		goto yy2;
	}
#line 80 "parse/lex_conf.re"
	{
...
yy173:
#line 146 "parse/lex_conf.re"
	{ RET_CONF_BOOL(bFlag); }
#line 982 "parse/lex_conf.cc"
yy174:
	yych = (unsigned char)*++cur;
	if (yych == 'a') goto yy22;
...
yy176:
#line 147 "parse/lex_conf.re"
	{ RET_CONF_BOOL(dFlag); }
#line 1008 "parse/lex_conf.cc"
yy177:
	yych = (unsigned char)*++cur;
	if (yych <= '_') {
		if (yych <= ':') {
...
yy178:
#line 156 "parse/lex_conf.re"
	{ RET_CONF_ENC(Enc::EBCDIC); }
#line 1034 "parse/lex_conf.cc"
yy179:
	yych = (unsigned char)*++cur;
	if (yybm[0+yych] & 32) {
		goto yy2;
...
yy180:
#line 148 "parse/lex_conf.re"
	{ RET_CONF_BOOL(gFlag); }
#line 1043 "parse/lex_conf.cc"
yy181:
	yych = (unsigned char)*++cur;
...
#line 150 "parse/lex_conf.re"
	{ RET_CONF_BOOL(sFlag); }
#line 1055 "parse/lex_conf.cc"
yy183:
	yych = (unsigned char)*++cur;
	if (yych <= '^') {
		if (yych <= '/') {
...
yy185:
#line 157 "parse/lex_conf.re"
	{ RET_CONF_ENC(Enc::UTF32); }
#line 1102 "parse/lex_conf.cc"
yy186:
	yych = (unsigned char)*++cur;
	if (yych <= 'Z') {
		if (yych <= '/') {
...
yy187:
#line 158 "parse/lex_conf.re"
	{ RET_CONF_ENC(Enc::UCS2); }
#line 1123 "parse/lex_conf.cc"
yy188:
	yych = (unsigned char)*++cur;
	if (yybm[0+yych] & 32) {
		goto yy2;
	}
#line 159 "parse/lex_conf.re"
	{ RET_CONF_ENC(Enc::UTF16); }
#line 1131 "parse/lex_conf.cc"
yy189:
	yych = (unsigned char)*++cur;
	if (yych <= 'r') goto yy3;
...
#line 73 "parse/lex_conf.re"
	{ opts.set_sentinel(lex_conf_eof()); return; }
#line 1360 "parse/lex_conf.cc"
yy240:
	yych = (unsigned char)*++cur;
...
#line 133 "parse/lex_conf.re"
	{ RET_CONF_BOOL(yybmHexTable); }
#line 1392 "parse/lex_conf.cc"
yy247:
	yych = (unsigned char)*++cur;
...
#line 61 "parse/lex_conf.re"
	{ RET_CONF_STR(api_sigil); }
#line 1420 "parse/lex_conf.cc"
yy253:
	yych = (unsigned char)*++cur;
	if (yybm[0+yych] & 32) {
		goto yy2;
	}
#line 60 "parse/lex_conf.re"
	{ lex_conf_api_style(opts); return; }
#line 1428 "parse/lex_conf.cc"
yy254:
	yych = (unsigned char)*++cur;
...
yy261:
	...
	if (yych == '@') goto yy307;
yy262:
#line 140 "parse/lex_conf.re"
	{ RET_CONF_STR(condGoto); }
#line 1467 "parse/lex_conf.cc"
yy263:
	yych = (unsigned char)*++cur;
...
#line 131 "parse/lex_conf.re"
	{ RET_CONF_BOOL(bEmitYYCh); }
#line 1621 "parse/lex_conf.cc"
yy297:
	yych = (unsigned char)*++cur;
...
#line 136 "parse/lex_conf.re"
	{ RET_CONF_STR(condPrefix); }
#line 1699 "parse/lex_conf.cc"
yy311:
	yych = (unsigned char)*++cur;
...
#line 166 "parse/lex_conf.re"
	{ RET_CONF_NUM_NONNEG(topIndent); }
#line 1814 "parse/lex_conf.cc"
yy335:
	yych = (unsigned char)*++cur;
...
yy343:
#line 173 "parse/lex_conf.re"
	{ RET_CONF_STR(startlabel); }
#line 1867 "parse/lex_conf.cc"
yy344:
	yych = (unsigned char)*++cur;
...
#line 153 "parse/lex_conf.re"
	{ RET_CONF_BOOL(case_ranges); }
#line 1925 "parse/lex_conf.cc"
yy357:
	yych = (unsigned char)*++cur;
...
#line 163 "parse/lex_conf.re"
	{ lex_conf_empty_class(opts); return; }
#line 2027 "parse/lex_conf.cc"
yy381:
	yych = (unsigned char)*++cur;
...
#line 168 "parse/lex_conf.re"
	{ RET_CONF_STR(labelPrefix); }
#line 2101 "parse/lex_conf.cc"
yy398:
	yych = (unsigned char)*++cur;
...
#line 143 "parse/lex_conf.re"
	{ RET_CONF_BOOL(bUseStateAbort); }
#line 2143 "parse/lex_conf.cc"
yy402:
	yych = (unsigned char)*++cur;
...
#line 86 "parse/lex_conf.re"
	{ RET_CONF_STR(tags_prefix); }
#line 2159 "parse/lex_conf.cc"
yy405:
	yych = (unsigned char)*++cur;
	if (yych <= 'c') {
		if (yych <= '`') goto yy3;
...
yy414:
	...
	if (yych == '@') goto yy470;
yy415:
#line 138 "parse/lex_conf.re"
	{ RET_CONF_STR(condDivider); }
#line 2215 "parse/lex_conf.cc"
yy416:
	yych = (unsigned char)*++cur;
...
#line 171 "parse/lex_conf.re"
	{ RET_CONF_STR(yynext); }
#line 2357 "parse/lex_conf.cc"
yy448:
	yych = (unsigned char)*++cur;
	if (yybm[0+yych] & 32) {
		goto yy2;
	}
#line 169 "parse/lex_conf.re"
	{ RET_CONF_STR(yyfilllabel); }
#line 2365 "parse/lex_conf.cc"
yy449:
	yych = (unsigned char)*++cur;
	if (yybm[0+yych] & 32) {
		goto yy2;
	}
#line 170 "parse/lex_conf.re"
	{ RET_CONF_STR(yyloop); }
#line 2373 "parse/lex_conf.cc"
yy450:
	yych = (unsigned char)*++cur;
...
yy453:
	cur = ctx;
#line 172 "parse/lex_conf.re"
	{ RET_CONF_BOOL(startlabel_force); }
#line 2389 "parse/lex_conf.cc"
yy454:
	++cur;
	if (lim <= cur) YYFILL(1);
	yych = (unsigned char)*cur;
...
#line 77 "parse/lex_conf.re"
	{ RET_CONF_BOOL(fill_check); }
#line 2438 "parse/lex_conf.cc"
yy464:
	yych = (unsigned char)*++cur;
...
#line 152 "parse/lex_conf.re"
	{ RET_CONF_BOOL(bCaseInverted); }
#line 2458 "parse/lex_conf.cc"
yy468:
	yych = (unsigned char)*++cur;
...
yy480:
#line 96 "parse/lex_conf.re"
	{ RET_CONF_STR(fill); }
#line 2525 "parse/lex_conf.cc"
yy481:
	yych = (unsigned char)*++cur;
...
#line 108 "parse/lex_conf.re"
	{ RET_CONF_STR(yypeek); }
#line 2558 "parse/lex_conf.cc"
yy488:
	yych = (unsigned char)*++cur;
...
#line 121 "parse/lex_conf.re"
	{ RET_CONF_STR(yyskip); }
#line 2582 "parse/lex_conf.cc"
yy493:
	yych = (unsigned char)*++cur;
...
#line 165 "parse/lex_conf.re"
	{ RET_CONF_STR(indString); }
#line 2631 "parse/lex_conf.cc"
yy503:
	yych = (unsigned char)*++cur;
...
yy509:
#line 132 "parse/lex_conf.re"
	{ RET_CONF_STR(yybm); }
#line 2673 "parse/lex_conf.cc"
yy510:
	yych = (unsigned char)*++cur;
	if (yych <= '@') {
		if (yych <= '/') {
...
yy511:
#line 129 "parse/lex_conf.re"
	{ RET_CONF_STR(yych); }
#line 2695 "parse/lex_conf.cc"
yy512:
	yych = (unsigned char)*++cur;
...
#line 75 "parse/lex_conf.re"
	{ RET_CONF_BOOL(fill_use); }
#line 2719 "parse/lex_conf.cc"
yy517:
	yych = (unsigned char)*++cur;
...
yy522:
	++cur;
#line 141 "parse/lex_conf.re"
	{ RET_CONF_STR(condGotoParam); }
#line 2762 "parse/lex_conf.cc"
yy523:
	yych = (unsigned char)*++cur;
	if (yybm[0+yych] & 32) {
		goto yy2;
	}
#line 137 "parse/lex_conf.re"
	{ RET_CONF_STR(condEnumPrefix); }
#line 2770 "parse/lex_conf.cc"
yy524:
	yych = (unsigned char)*++cur;
...
#line 92 "parse/lex_conf.re"
	{ RET_CONF_STR(yyctype); }
#line 2790 "parse/lex_conf.cc"
yy528:
	yych = (unsigned char)*++cur;
...
#line 95 "parse/lex_conf.re"
	{ RET_CONF_STR(yydebug); }
#line 2802 "parse/lex_conf.cc"
yy530:
	yych = (unsigned char)*++cur;
...
#line 104 "parse/lex_conf.re"
	{ RET_CONF_STR(yylimit); }
#line 2830 "parse/lex_conf.cc"
yy536:
	yych = (unsigned char)*++cur;
...
#line 106 "parse/lex_conf.re"
	{ RET_CONF_STR(yymtagn); }
#line 2842 "parse/lex_conf.cc"
yy538:
	yych = (unsigned char)*++cur;
	if (yybm[0+yych] & 32) {
		goto yy2;
	}
#line 107 "parse/lex_conf.re"
	{ RET_CONF_STR(yymtagp); }
#line 2850 "parse/lex_conf.cc"
yy539:
	yych = (unsigned char)*++cur;
...
yy543:
#line 118 "parse/lex_conf.re"
	{ RET_CONF_STR(yyshift); }
#line 2886 "parse/lex_conf.cc"
yy544:
	yych = (unsigned char)*++cur;
	if (yybm[0+yych] & 32) {
		goto yy2;
	}
#line 122 "parse/lex_conf.re"
	{ RET_CONF_STR(yystagn); }
#line 2894 "parse/lex_conf.cc"
yy545:
	yych = (unsigned char)*++cur;
	if (yybm[0+yych] & 32) {
		goto yy2;
	}
#line 123 "parse/lex_conf.re"
	{ RET_CONF_STR(yystagp); }
#line 2902 "parse/lex_conf.cc"
yy546:
	yych = (unsigned char)*++cur;
...
#line 149 "parse/lex_conf.re"
	{ RET_CONF_NUM_NONNEG(cGotoThreshold); }
#line 2971 "parse/lex_conf.cc"
yy562:
	yych = (unsigned char)*++cur;
...
yy564:
#line 89 "parse/lex_conf.re"
	{ RET_CONF_STR(yybackup); }
#line 2997 "parse/lex_conf.cc"
yy565:
	yych = (unsigned char)*++cur;
...
#line 94 "parse/lex_conf.re"
	{ RET_CONF_STR(yycursor); }
#line 3013 "parse/lex_conf.cc"
yy568:
	yych = (unsigned char)*++cur;
...
#line 105 "parse/lex_conf.re"
	{ RET_CONF_STR(yymarker); }
#line 3041 "parse/lex_conf.cc"
yy574:
	yych = (unsigned char)*++cur;
...
#line 162 "parse/lex_conf.re"
	{ lex_conf_encoding_policy(opts); return; }
#line 3069 "parse/lex_conf.cc"
yy580:
	yych = (unsigned char)*++cur;
...
#line 144 "parse/lex_conf.re"
	{ RET_CONF_BOOL(bUseStateNext); }
#line 3089 "parse/lex_conf.cc"
yy584:
	yych = (unsigned char)*++cur;
	if (yybm[0+yych] & 32) {
		goto yy2;
	}
#line 87 "parse/lex_conf.re"
	{ RET_CONF_STR(tags_expression); }
#line 3097 "parse/lex_conf.cc"
yy585:
	yych = (unsigned char)*++cur;
...
#line 130 "parse/lex_conf.re"
	{ RET_CONF_BOOL(yychConversion); }
#line 3125 "parse/lex_conf.cc"
yy591:
	yych = (unsigned char)*++cur;
...
#line 151 "parse/lex_conf.re"
	{ RET_CONF_BOOL(bCaseInsensitive); }
#line 3137 "parse/lex_conf.cc"
yy593:
	yych = (unsigned char)*++cur;
...
yy603:
#line 109 "parse/lex_conf.re"
	{ RET_CONF_STR(yyrestore); }
#line 3197 "parse/lex_conf.cc"
yy604:
	yych = (unsigned char)*++cur;
...
#line 128 "parse/lex_conf.re"
	{ RET_CONF_STR(yystate); }
#line 3237 "parse/lex_conf.cc"
yy613:
	yych = (unsigned char)*++cur;
...
#line 76 "parse/lex_conf.re"
	{ RET_CONF_BOOL(fill_arg_use); }
#line 3249 "parse/lex_conf.cc"
yy615:
	++cur;
#line 139 "parse/lex_conf.re"
	{ RET_CONF_STR(condDividerParam); }
#line 3254 "parse/lex_conf.cc"
yy616:
	yych = (unsigned char)*++cur;
...
#line 91 "parse/lex_conf.re"
	{ RET_CONF_STR(yycondtype); }
#line 3266 "parse/lex_conf.cc"
yy618:
	yych = (unsigned char)*++cur;
...
yy620:
	++cur;
#line 97 "parse/lex_conf.re"
	{ RET_CONF_STR(fill_arg); }
#line 3279 "parse/lex_conf.cc"
yy621:
	yych = (unsigned char)*++cur;
...
yy623:
#line 101 "parse/lex_conf.re"
	{ RET_CONF_STR(state_get); }
#line 3305 "parse/lex_conf.cc"
yy624:
	yych = (unsigned char)*++cur;
	if (yybm[0+yych] & 32) {
		goto yy2;
	}
#line 103 "parse/lex_conf.re"
	{ RET_CONF_STR(yylessthan); }
#line 3313 "parse/lex_conf.cc"
yy625:
	yych = (unsigned char)*++cur;
...
yy629:
#line 115 "parse/lex_conf.re"
	{ RET_CONF_STR(state_set); }
#line 3348 "parse/lex_conf.cc"
yy630:
	yych = (unsigned char)*++cur;
...
#line 126 "parse/lex_conf.re"
	{ RET_CONF_STR(yyaccept); }
#line 3368 "parse/lex_conf.cc"
yy634:
	yych = (unsigned char)*++cur;
	if (yybm[0+yych] & 32) {
		goto yy2;
	}
#line 125 "parse/lex_conf.re"
	{ RET_CONF_STR(yyctable); }
#line 3376 "parse/lex_conf.cc"
yy635:
	yych = (unsigned char)*++cur;
	if (yybm[0+yych] & 32) {
		goto yy2;
	}
#line 134 "parse/lex_conf.re"
	{ lex_conf_string(); return; }
#line 3384 "parse/lex_conf.cc"
yy636:
	yych = (unsigned char)*++cur;
	if (yybm[0+yych] & 32) {
		goto yy2;
	}
#line 127 "parse/lex_conf.re"
	{ RET_CONF_STR(yytarget); }
#line 3392 "parse/lex_conf.cc"
yy637:
	yych = (unsigned char)*++cur;
	if (yybm[0+yych] & 32) {
		goto yy2;
	}
#line 90 "parse/lex_conf.re"
	{ RET_CONF_STR(yybackupctx); }
#line 3400 "parse/lex_conf.cc"
yy638:
	yych = (unsigned char)*++cur;
	if (yybm[0+yych] & 32) {
		goto yy2;
	}
#line 93 "parse/lex_conf.re"
	{ RET_CONF_STR(yyctxmarker); }
#line 3408 "parse/lex_conf.cc"
yy639:
	yych = (unsigned char)*++cur;
...
#line 120 "parse/lex_conf.re"
	{ RET_CONF_STR(yyshiftmtag); }
#line 3448 "parse/lex_conf.cc"
yy648:
	yych = (unsigned char)*++cur;
	if (yybm[0+yych] & 32) {
		goto yy2;
	}
#line 119 "parse/lex_conf.re"
	{ RET_CONF_STR(yyshiftstag); }
#line 3456 "parse/lex_conf.cc"
yy649:
	yych = (unsigned char)*++cur;
...
#line 98 "parse/lex_conf.re"
	{ RET_CONF_BOOL(fill_naked); }
#line 3468 "parse/lex_conf.cc"
yy651:
	yych = (unsigned char)*++cur;
...
#line 110 "parse/lex_conf.re"
	{ RET_CONF_STR(yyrestorectx); }
#line 3484 "parse/lex_conf.cc"
yy654:
	yych = (unsigned char)*++cur;
	if (yybm[0+yych] & 32) {
		goto yy2;
	}
#line 111 "parse/lex_conf.re"
	{ RET_CONF_STR(yyrestoretag); }
#line 3492 "parse/lex_conf.cc"
yy655:
	yych = (unsigned char)*++cur;
...
yy665:
#line 99 "parse/lex_conf.re"
	{ RET_CONF_STR(cond_get); }
#line 3550 "parse/lex_conf.cc"
yy666:
	yych = (unsigned char)*++cur;
...
yy668:
#line 112 "parse/lex_conf.re"
	{ RET_CONF_STR(cond_set); }
#line 3577 "parse/lex_conf.cc"
yy669:
	yych = (unsigned char)*++cur;
...
#line 102 "parse/lex_conf.re"
	{ RET_CONF_BOOL(state_get_naked); }
#line 3621 "parse/lex_conf.cc"
yy679:
	yych = (unsigned char)*++cur;
...
#line 116 "parse/lex_conf.re"
	{ RET_CONF_BOOL(state_set_naked); }
#line 3637 "parse/lex_conf.cc"
yy682:
	++cur;
#line 117 "parse/lex_conf.re"
	{ RET_CONF_STR(state_set_arg); }
#line 3642 "parse/lex_conf.cc"
yy683:
	yych = (unsigned char)*++cur;
...
yy691:
	++cur;
#line 113 "parse/lex_conf.re"
	{ RET_CONF_STR(cond_set_arg); }
#line 3679 "parse/lex_conf.cc"
yy692:
	yych = (unsigned char)*++cur;
	if (yybm[0+yych] & 32) {
		goto yy2;
	}
#line 100 "parse/lex_conf.re"
	{ RET_CONF_BOOL(cond_get_naked); }
#line 3687 "parse/lex_conf.cc"
yy693:
	yych = (unsigned char)*++cur;
	if (yybm[0+yych] & 32) {
		goto yy2;
	}
#line 114 "parse/lex_conf.re"
	{ RET_CONF_BOOL(cond_set_naked); }
#line 3695 "parse/lex_conf.cc"
}
#line 179 "parse/lex_conf.re"
...
yy706:
	++cur;
#line 193 "parse/lex_conf.re"
	{ opts.set_encoding_policy(Enc::POLICY_FAIL);       goto end; }
#line 3767 "parse/lex_conf.cc"
yy707:
	yych = (unsigned char)*++cur;
...
yy711:
	++cur;
#line 191 "parse/lex_conf.re"
	{ opts.set_encoding_policy(Enc::POLICY_IGNORE);     goto end; }
#line 3788 "parse/lex_conf.cc"
yy712:
	yych = (unsigned char)*++cur;
	...
	++cur;
#line 192 "parse/lex_conf.re"
	{ opts.set_encoding_policy(Enc::POLICY_SUBSTITUTE); goto end; }
#line 3801 "parse/lex_conf.cc"
}
#line 194 "parse/lex_conf.re"
...
yy714:
	++cur;
yy715:
#line 203 "parse/lex_conf.re"
	{
        msg.error(cur_loc(),
            "bad configuration value (expected: 'default', 'custom')");
        exit(1);
    }
#line 3830 "parse/lex_conf.cc"
yy716:
	yych = (unsigned char)*(mar = ++cur);
...
yy727:
	++cur;
#line 209 "parse/lex_conf.re"
	{ opts.set_input_api(INPUT_CUSTOM);  goto end; }
#line 3877 "parse/lex_conf.cc"
yy728:
	yych = (unsigned char)*++cur;
	if (yych != 't') goto yy719;
	++cur;
#line 208 "parse/lex_conf.re"
	{ opts.set_input_api(INPUT_DEFAULT); goto end; }
#line 3884 "parse/lex_conf.cc"
}
#line 210 "parse/lex_conf.re"
...
yy749:
	++cur;
#line 225 "parse/lex_conf.re"
	{ opts.set_empty_class_policy(EMPTY_CLASS_MATCH_NONE);  goto end; }
#line 3990 "parse/lex_conf.cc"
yy750:
	++cur;
#line 224 "parse/lex_conf.re"
	{ opts.set_empty_class_policy(EMPTY_CLASS_MATCH_EMPTY); goto end; }
#line 3995 "parse/lex_conf.cc"
}
#line 227 "parse/lex_conf.re"
...
#line 4007 "parse/lex_conf.cc"
{
	...
	++cur;
yy752:
#line 236 "parse/lex_conf.re"
	{
        msg.error(cur_loc(),
            "bad configuration value (expected: 'functions', 'free-form')");
        exit(1);
    }
#line 4021 "parse/lex_conf.cc"
yy753:
	yych = (unsigned char)*(mar = ++cur);
...
yy769:
	++cur;
#line 242 "parse/lex_conf.re"
	{ opts.set_api_style(API_FREEFORM);  goto end; }
#line 4089 "parse/lex_conf.cc"
yy770:
	++cur;
#line 241 "parse/lex_conf.re"
	{ opts.set_api_style(API_FUNCTIONS); goto end; }
#line 4094 "parse/lex_conf.cc"
}
#line 243 "parse/lex_conf.re"
...
#line 4105 "parse/lex_conf.cc"
{
	...
	++cur;
yy772:
#line 251 "parse/lex_conf.re"
	{
        msg.error(cur_loc(), "missing '=' in configuration");
        exit(1);
    }
#line 4157 "parse/lex_conf.cc"
yy773:
	yych = (unsigned char)*(mar = ++cur);
	if (yych <= 0x1F) {
		if (yych == '\t') goto yy775;
...
#line 255 "parse/lex_conf.re"
	{ return; }
#line 4176 "parse/lex_conf.cc"
yy775:
	++cur;
	if (lim <= cur) YYFILL(1);
	yych = (unsigned char)*cur;
...
#line 4197 "parse/lex_conf.cc"
{
	...
	++cur;
yy777:
#line 262 "parse/lex_conf.re"
	{
        msg.error(cur_loc(), "missing ending ';' in configuration");
        exit(1);
    }
#line 4249 "parse/lex_conf.cc"
yy778:
	yych = (unsigned char)*(mar = ++cur);
	if (yybm[0+yych] & 128) {
		goto yy780;
...
yy779:
	++cur;
#line 266 "parse/lex_conf.re"
	{ return; }
#line 4260 "parse/lex_conf.cc"
yy780:
	++cur;
	if (lim <= cur) YYFILL(1);
	yych = (unsigned char)*cur;
...
yy788:
#line 318 "parse/lex_conf.re"
	{ goto end; }
#line 4430 "parse/lex_conf.cc"
yy789:
	++cur;
	if (lim <= cur) YYFILL(1);
	yych = (unsigned char)*cur;
...
#line 314 "parse/lex_conf.re"
	{
        s = getstr(tok, cur);
        goto end;
    }
#line 4443 "parse/lex_conf.cc"
yy790:
	++cur;
#line 297 "parse/lex_conf.re"
	{
...
#line 4464 "parse/lex_conf.cc"
}
#line 319 "parse/lex_conf.re"
