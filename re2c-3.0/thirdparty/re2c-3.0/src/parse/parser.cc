...
#line 1238 "parse/parser.cc"
    break;

  case 18: /* rule: TOKEN_CLIST '*' ccode  */
#line 118 "parse/parser.ypp"
                        {
    for(CondList::const_iterator i = (yyvsp[-2].clist)->begin(); i != (yyvsp[-2].clist)->end(); ++i) {
...
#line 1249 "parse/parser.cc"
    break;

  case 19: /* rule: TOKEN_CLIST '$' ccode  */
#line 124 "parse/parser.ypp"
                        {
    for(CondList::const_iterator i = (yyvsp[-2].clist)->begin(); i != (yyvsp[-2].clist)->end(); ++i) {
...
#line 1260 "parse/parser.cc"
    break;

  case 20: /* rule: TOKEN_CSETUP TOKEN_CODE  */
#line 130 "parse/parser.ypp"
                          {
...
#line 1346 "parse/parser.cc"
    break;

  case 35: /* factor: primary TOKEN_CLOSESIZE  */
#line 187 "parse/parser.ypp"
                          {
    (yyval.regexp) = ast_iter((yyvsp[-1].regexp), (yyvsp[0].bounds).min, (yyvsp[0].bounds).max);
}
#line 1354 "parse/parser.cc"
    break;

  case 37: /* closes: closes close  */
#line 194 "parse/parser.ypp"
               { (yyval.op) = ((yyvsp[-1].op) == (yyvsp[0].op)) ? (yyvsp[-1].op) : '*'; }
#line 1360 "parse/parser.cc"
    break;

  case 38: /* close: '*'  */
#line 198 "parse/parser.ypp"
      { (yyval.op) = '*'; }
#line 1366 "parse/parser.cc"
    break;

  case 39: /* close: '+'  */
#line 199 "parse/parser.ypp"
      { (yyval.op) = '+'; }
#line 1372 "parse/parser.cc"
    break;

  case 40: /* close: '?'  */
#line 200 "parse/parser.ypp"
      { (yyval.op) = '?'; }
#line 1378 "parse/parser.cc"
    break;

  case 42: /* primary: TOKEN_ID  */
#line 205 "parse/parser.ypp"
           {
...
#line 1390 "parse/parser.cc"
    break;

  case 43: /* primary: '(' expr ')'  */
#line 212 "parse/parser.ypp"
               { (yyval.regexp) = ast_cap((yyvsp[-1].regexp)); }
#line 1396 "parse/parser.cc"
    break;


#line 1400 "parse/parser.cc"
